...
export class PaymentComponent {
  ...
  onSubmit():void {
    ...
    this.options.prefill.name = "Gayatri Awasthi"
    this.options.prefill.email = "gayatriawasthi25@gmail.com";
    this.options.prefill.contact = "7776982111";
